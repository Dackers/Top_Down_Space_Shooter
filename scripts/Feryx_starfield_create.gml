///Feryx_starfield_create(horizontal_speed, vertical_speed, horizontal_texture, vertical_texture, stars_layer_density, stars_maximal_size)

/*
    For normal white stars, use:
...
// Generate backgrounds in memory
back1 = 0;
back2 = 0;
back3 = 0;
back4 = 0;
...
// Check if stars visible, and if not change the visible flag to true!
